...
import 'post_question_page_model.dart';
export 'post_question_page_model.dart';

class PostQuestionPageWidget extends StatefulWidget {
  const PostQuestionPageWidget({super.key});

  @override
  State<PostQuestionPageWidget> createState() => _PostQuestionPageWidgetState();
}

class _PostQuestionPageWidgetState extends State<PostQuestionPageWidget> {
  late PostQuestionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostQuestionPageModel());
